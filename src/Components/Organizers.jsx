...
const Organizers = () => {
  ...
  return (
    <div className="bg-gray-100 py-10 px-4 md:px-8 w-11/12 mx-auto mt-10 rounded-2xl shadow-lg">
      <h2 className="text-3xl md:text-4xl font-bold text-blue-600 mb-8 text-center">Organizers</h2>
      <Slider {...settings}>
        {bills.map((bill) => (
          <div
            key={bill.id}
          ...
          >
            ...
            <div className="px-4 pb-4 w-full">
              <h3 className="text-lg font-semibold text-gray-800 mb-1">{bill.organization}</h3>
              <p className="text-sm text-blue-500 capitalize mb-2">{bill.bill_type}</p>
